...
export const ceMacro = KaTeX.__defineMacro('\\ce', function (context) {
  return chemParse(context.consumeArgs(1)[0], 'ce')
})

export const puMacro = KaTeX.__defineMacro('\\pu', function (context) {
...
export const trippleDashMacro = KaTeX.__defineMacro(
  '\\tripledash',
