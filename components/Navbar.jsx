const Navbar = () => {
  return (
    <>
      <nav className='flex justify-between max-w-6xl py-8 mx-auto'>
        <div className='inline-block text-2xl '>
          <span className=''>⚛️Gleichgewicht</span>
        </div>
        <div className='flex space-x-5 text-gray-500'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://github.com/fabiwo/katex2reaction'
          >
            <svg
              height='16'
              width='16'
              ...
              className='cursor-pointer fill-current w-7 h-7'
            >
